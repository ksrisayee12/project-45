var DIMENSIONS = { width: 540, height: 720 };

var WIDTH = 7; // how many cells can fit
var STARTING_WIDTH = 3; // base cell count

/* highest stack */
var MID_HEIGHT = Math.floor(DIMENSIONS.height / (DIMENSIONS.width / WIDTH) / 2);
